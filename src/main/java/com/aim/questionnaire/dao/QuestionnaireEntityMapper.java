...
public interface QuestionnaireEntityMapper {
   ...
   * @return
   */
  int addQuestionRecordAnswerCount(
      @Param("list") List<Map<String, Object>> resultList, @Param("tableName") String tableName);
   ...
   * @return
   */
  int addQuestionRecordAnswerSchool(
      @Param("list") List<Map<String, Object>> resultList, @Param("tableName") String tableName);
   ...
   * @return
   */
  int modifyQuestionRecordAnswerSchool(
      @Param("tableName") String tableName, @Param("list") List<Map<String, Object>> resultList);
   ...
   * @return
   */
  int deleteTableByTableName(
      @Param("tableNameAnswer") String tableNameAnswer,
